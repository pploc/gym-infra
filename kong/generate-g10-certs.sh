...
issue g10-ca ms-gym-member 'DNS:ms-gym-member' serverAuth
issue g10-ca ms-gym-plans 'DNS:ms-gym-plans' serverAuth
...
issue g10-ca identifier 'DNS:ms-gym-identifier,URI:spiffe://gym.cluster.local/ns/gym-system/sa/ms-gym-identifier' clientAuth
issue g10-ca member-client 'DNS:ms-gym-member,URI:spiffe://gym.cluster.local/ns/gym-system/sa/ms-gym-member' clientAuth
...
for service in checkin gateway kong member plans identifier; do
  mkdir -p "$out/runtime/$service"
  cp "$out/g10-ca.crt" "$out/runtime/$service/"
done
